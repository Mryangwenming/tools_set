...
def run(source_file, dest_file, dest_pdf_file, only_pdf):
    ...
    f_r.write("""<style type="text/css">div {display: block;font-family: "Times New Roman",Georgia,Serif}\
            ...
            width: 0%;  height: 100%;  }#second {   float:left;   width: 80%;height: 100%;   \
            }#right {float:left;  width: 0%;  height: 100%; \
...
def main():
    ...
    run('387f1558d54644a40ea3c49d9abb79.md', 'demo1.html', 'demo1.pdf', False)
